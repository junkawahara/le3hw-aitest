...
\lstinputlisting[caption={alu.v},label={lst:alu}]{../simple/alu.v}
...
\lstinputlisting[caption={shifter.v},label={lst:shifter}]{../simple/shifter.v}
...
\lstinputlisting[caption={regfile.v},label={lst:regfile}]{../simple/regfile.v}
...
\lstinputlisting[caption={mem.v},label={lst:mem}]{../simple/mem.v}
...
\lstinputlisting[caption={simple\_cpu.v},label={lst:cpu}]{../simple/simple_cpu.v}
...
\lstinputlisting[caption={simple\_top.v},label={lst:top}]{../simple/simple_top.v}
...
\lstinputlisting[caption={simple\_tb.v --- テストベンチ},label={lst:tb}]{../simple/simple_tb.v}
